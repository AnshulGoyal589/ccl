...
<body>
    <div class="container">
        <h2 class="mb-4">Select Your Location</h2>
        <form id="locationForm">
            <!-- State Dropdown -->
            <div class="mb-3">
                <label for="state" class="form-label">State</label>
                <select id="state" class="form-select" onchange="populateCities()" required>
    ...
    <!-- JavaScript -->
    <script>
        // Step 1: Define states and cities
        const stateCityMap = {
            ...
            "Himachal Pradesh": ["Baddi", "Mandi", "Nahan", "Palampur", "Shimla", "Solan", "Sundarnagar"],

            "Jammu and Kashmir": ["Anantnag", "Baramula", "Jammu", "Kathua", "Punch", "Rajauri", "Sopore", "Shrinagar", "Udhampur"],
        ...
        // Step 2: Populate the states dropdown
        ...
        // Step 3: Populate the cities based on the selected state
