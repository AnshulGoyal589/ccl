...
<body>
    ...
    <div id="imagePopup" class="popup-overlay">
        ...
        <div class="popup-content">
            ...
            <img height="400" src="https://res.cloudinary.com/dxk6wjttq/image/upload/v1753969781/qr4_wkvbl6.jpg" alt="QR Code">
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-md-8 text-black">
                    ...
                    <form id="registration-form" action="reg-submit2.php" method="POST">
                        <!-- Name Field -->
                        <div class="mb-3">
                        ...
                        <!-- Payment Button -->
                        <div class="mb-3">
                            <button type="button" id="scan-qr-btn" class="btn btn-primary w-100 scan-qr-btn">Scan QR Code to Make Payment</button>
                        </div>
